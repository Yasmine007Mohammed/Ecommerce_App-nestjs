...
-- CreateEnum
CREATE TYPE "OrderSatus" AS ENUM ('PENDING', 'PROCESSING', 'SHIPPED', 'DELEVERED', 'CANCELLED');
...
-- CreateIndex
CREATE INDEX "orders_statuse_idx" ON "orders"("statuse");
